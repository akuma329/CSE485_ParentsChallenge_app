...
The Schuck Family`,
    image: require("../assets/board/joyce.jpg"), // set this later to require("../assets/board/joyce.jpg"), and for all other members too. Need to ask Deborah for the official board member photos
  },
  {
    id: "stephen-m-schuck",
...
`,
    image: require("../assets/board/stephen.jpg"),
  },
  {
    id: "joe-woodford",
    name: "JOE WOODFORD",
    subtitle: "",
    years: "",
    description: `Joe Woodford retired from active management of WCM Industries, Inc in 2006 after over 40 years with the company, most of that time as President/CEO, and he continues with WCM as its Board Chairman. WCM had two operating divisions, Woodford Manufacturing in Colorado Springs, Colorado and Watco Manufacturing in Independence, Missouri when he retired and the company now has two more divisions, ISIMET/MAPA in Naples, Texas and Perma-Cast in Pueblo, Colorado.
...
`,
    image: require("../assets/board/joe.jpg"),
  },
  {
    id: "steven-l-everson",
...
`,
    image: require("../assets/board/steve.jpg"),
  },
  {
    id: "kim-shugart",
    name: "KIM SHUGART",
...
`,
    image: require("../assets/board/kim.jpg"),
  },
  {
    id: "mike-miles",
    name: "MIKE MILES",
    subtitle: "",
    years: "",
    description: `Mike Miles was appointed Superintendent of the Houston Independent School District on June 1, 2023, and left his position as the CEO of Third Future Schools, a network of high-quality public schools in Colorado and Texas that he founded in 2016.

Prior to his latest work, Mike served three years as the Superintendent of the Dallas Independent School District and six years as the Superintendent of the Harrison School District in Colorado Springs. Under his leadership, both districts
implemented ground-breaking initiatives, established a high-performance culture, and experienced significant growth in student achievement.
...
`,
    image: require("../assets/board/mike.jpg"),
  },
  {
    id: "robert-gardner",
    name: "ROBERT GARDNER",
...
`,
    image: require("../assets/board/rob.jpg"),
  },
  {
    id: "lisa-jesse",
    name: "LISA JESSE",
...
`,
    image: require("../assets/board/lisa.jpg"),
  },
  {
    id: "regina-lewis",
    ...
    subtitle: "",
    years: "",
    description: `Dr. Regina Lewis is a trailblazer in professional communication, leadership development, and public speaking. As the founder and visionary behind the ReginaSpeaking Academy, she has created a nationally recognized platform for cultivating dynamic speakers and influential leaders. Her Academy’s signature methodology, rooted in the “Chemistry of Public Speaking,” has transformed professionals, from emerging entrepreneurs to seasoned executives, by equipping them with the presence, persuasion, and power to lead through spoken word. 

Dr. Lewis is widely celebrated for her energetic, authentic, and deeply motivational speaking style. Audiences consistently describe her as captivating, relatable, and profoundly inspiring. Her ability to connect from the heart, while inspiring others to strive for excellence, has made her a highly sought-after keynote speaker and executive coach across various industries and continents.

As CEO of ReginaSpeaking, LLC, Dr. Lewis brings over two decades of experience to her global consulting practice. She has partnered with Fortune 500 companies, government agencies, nonprofits, and academic institutions in the United States, Ethiopia, Vietnam, Brazil, China, Lebanon, Saudi Arabia, and beyond. Her areas of expertise include public speaking, executive presence, organizational communication, inclusive leadership, strategic visioning, entrepreneurship, and cultural intelligence.

A signature accomplishment in her career is the award-winning CEID program (Cultural Excellence: Ideas and Discussions). What sets Dr. Lewis apart is her inclusive, non-blaming, and non-shaming approach to cultural work. She creates brave spaces where everyone is included in the journey toward excellence, inviting honest dialogue, reflection, and growth. Her CEID sessions are known for sparking transformative conversations that build bridges and foster trust across diverse teams and communities.

Dr. Lewis’s influence is rooted not just in her credentials but in her lived experience. A proud U.S. Air Force war veteran and Professor Emerita at Pikes Peak State College, she brings courage, discipline, and purpose to every endeavor. Her academic foundation includes a Doctorate in Educational Leadership, Research, and Policy, a Master’s in Communication, and dual Bachelor’s degrees in Communication and Psychology.
